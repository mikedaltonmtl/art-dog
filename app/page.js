...
const images = [
  { name: romy001, desc: 'Dog by the fireplace' },
  { name: romy002, desc: 'Dog' },
  { name: romy003, desc: 'Dog' },
  { name: romy004, desc: 'Dog' },
  { name: romy005, desc: 'Dog' },
  { name: romy006, desc: 'Dog' },
  { name: romy007, desc: 'Dog' },
];
  ...
  return (
    <main className={styles.main}>
      <div className={styles.description}>
        ...
        {/* <Image src={romy001} alt="Dog by the fireplace" height={300} placeholder="blur" /> */}
        <div>
          <a
